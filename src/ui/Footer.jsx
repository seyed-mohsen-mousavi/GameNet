  ...
  return (
    <footer className="relative mt-28 overflow-hidden ">
      <div className="mx-auto mb-3 text-center ">
        ...
        {/* Icons */}
        <div className="text-center  flex justify-center items-center gap-5  py-3">
          {/* Discord */}
          <a
            href="http://"
            title="Discord"
            target="_blank"
            className=" [&>svg]:h-5 [&>svg]:w-5 hover:scale-110 transition-all ease-linear "
            rel="noopener noreferrer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="fill-[#6a6cff] drop-shadow-[0px_0px_6px_#6a6cff]"
              viewBox="0 0 640 512"
            >
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="fill-[#fe7de1] drop-shadow-[0px_0px_6px_#fe7de1]"
              viewBox="0 0 448 512"
            >
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="fill-[#1bc6ff] drop-shadow-[0px_0px_6px_#1bc6ff]"
              viewBox="0 0 496 512"
            >
          ...
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="currentColor"
              className="fill-[#93ffb1] drop-shadow-[0px_0px_6px_#93ffb1]"
              viewBox="0 0 512 512"
            >
